...
| E01 — PTY 启动交互式 cbc | ✅ TUI 捕获 + 文本发送 | [e01](../experiments/02-pty-control/e01-interactive-cbc.js) |
| E02 — / 指令通过 PTY | ✅ /help /model /clear 可用 | [e02](../experiments/02-pty-control/e02-slash-commands.js) |
| E03 — 特殊按键 (Tab/Ctrl+C) | ✅ Tab thinking 切换；Ctrl+C 可发送 | [e03](../experiments/02-pty-control/e03-special-keys.js) |
...
| MEMORY.md 并发写入 | 需独立 workdir 隔离 | [c2](../experiments/03-concurrent/c2-resource-conflicts.js) |
